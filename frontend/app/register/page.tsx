      ...
      <main className="flex min-h-screen items-center justify-center bg-cream px-6 font-sans">
        <div className="w-full max-w-[380px]">
          ...
          <p className="mt-3 text-[13px] leading-relaxed text-muted">
            An administrator will review and approve your account before you can sign in. You&apos;ll
            be able to log in once it&apos;s active.
          </p>
          <div className="mt-8">
            <Link href="/login">
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-cream px-6 py-10 font-sans">
      <div className="w-full max-w-[380px]">
        ...
        <h1 className="font-serif text-[28px] leading-tight text-charcoal">Create your account</h1>
        <p className="mt-1 text-[13px] text-muted">Join OneFit as a member or a specialist.</p>
