...
import { getUsers, setUserRole, setUserStatus } from "../../api/admin";
...
export default function UserManagement({ onNav }) {
  ...
  // Optimistically flip role, then persist; reload on failure.
              ...
              >
                ...
                {menu === u.user_id && (
                  ...
                  >
                    ...
                    {u.role !== "gym_user" && (
                      <MenuItem onClick={() => applyRole(u.user_id, "gym_user")}>
                        Set role · Member
                      </MenuItem>
                    )}
                    {u.role !== "wellness_specialist" && (
                      <MenuItem onClick={() => applyRole(u.user_id, "wellness_specialist")}>
                        Set role · Specialist
                      </MenuItem>
                    )}
                    {u.role !== "admin" && (
                      <MenuItem onClick={() => applyRole(u.user_id, "admin")}>
                        Set role · Admin
                      </MenuItem>
                    )}
                  </div>
